...
public class intertrigo_profile extends AppCompatActivity {
    private ViewPager viewPager;
    private int skinDisease = 3;
    private HtmlTextView profile;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_intertrigo);
        ...
        String text="";
        try {
            InputStream inputStream = getAssets().open("intertrigo.html");
