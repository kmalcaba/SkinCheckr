...
public class melanoma_profile extends AppCompatActivity {
    private ViewPager viewPager;
    private int skinDisease = 4;
    private HtmlTextView profile;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_melanoma);
        ...
        String text="";
        try {
            InputStream inputStream = getAssets().open("melanoma.html");
