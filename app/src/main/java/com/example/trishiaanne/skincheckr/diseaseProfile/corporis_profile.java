...
public class corporis_profile extends AppCompatActivity {
    private ViewPager viewPager;
    private int skinDisease = 7;
    private HtmlTextView profile;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_corp);
        ...
        String text="";
        try {
            InputStream inputStream = getAssets().open("corp.html");
